...
See the [introductory tutorial](articles/introductory_tutorial.html) for an 
introduction to our framework on real data. See the 
[advanced tutorial](articles/advanced_uses.html) for examples of 
more advanced uses of `DiffSegR`.
